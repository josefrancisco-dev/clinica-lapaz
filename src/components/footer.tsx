      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">Clínica Lá Paz</span>
            </a>
            <p className="mt-4 text-background/70 text-sm">
              Há mais de 5 anos cuidando da saúde e bem-estar das famílias 
          ...
          {/* Services */}
          <div>
            <h4 className="font-semibold text-lg mb-4">Especialidades</h4>
            <ul className="flex flex-col gap-2">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-background/70">
              <li>
                ...
                <span>Rua da Liberdade Nº 71 Vila Alice – Luanda</span>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-background/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/60">
            © {new Date().getFullYear()} Clínica Lá Paz. Todos os direitos reservados.
          </p>
